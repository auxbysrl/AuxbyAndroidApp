...
class OfferAdapter(
    ...
    inner class ViewHolder(private val binding: ItemOfferBinding) :
        ...
        private fun ItemOfferBinding.setOfferStateBadge(offer: OfferModel) {
        ...
        private fun ItemOfferBinding.initListeners(offer: OfferModel) {
        ...
        private fun ItemOfferBinding.handleDisplayBidders(offer: OfferModel) {
        ...
        private fun ItemOfferBinding.defaultBidsState() {
        ...
        private fun ItemOfferBinding.setOfferDescription(offer: OfferModel) {
            if (offer.isOnAuction) {
                tvDescription.hide()
