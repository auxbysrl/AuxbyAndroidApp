package com.fivedevs.auxby.screens.dashboard.offers.categories.adapters
...
import com.fivedevs.auxby.databinding.ItemCategoryAllBinding
...
class AllCategoriesAdapter(
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemCategoryAllBinding.inflate(LayoutInflater.from(viewGroup.context), viewGroup, false)
    ...
    inner class ViewHolder(private val binding: ItemCategoryAllBinding) : RecyclerView.ViewHolder(binding.root) {
